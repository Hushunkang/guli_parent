...
//        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("E:\\ideaWorkspace01\\guli_parent\\service\\service_ucenter" + "/src/main/java");
        ...
        pc.setModuleName("ucenterservice");//模块名称
        ...
        strategy.setTablePrefix("ucenter_");//生成实体类时去掉表前缀，实际执行有去掉
