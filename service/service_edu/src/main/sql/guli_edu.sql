...
CREATE TABLE `edu_course` (
                              ...
                              `price` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '课程销售价格，设置为0.00则可免费观看',
...
CREATE TABLE `edu_course_description` (
                                          ...
                                          `gmt_modified` datetime NOT NULL COMMENT '更新时间',
                                          PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='课程简介表';

#
# Data for table "edu_course_description"
#

# 说明edu_course_description本身可以和edu_course表合二为一，但是为什么不这么做？？？
# 参照阿里巴巴的那个MySQL规约
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='课程小节表';
